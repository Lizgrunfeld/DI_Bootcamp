...
-- SELECT * FROM actors4 LIMIT 4;

-- SELECT * FROM actors4 ORDER BY last_name DESC LIMIT 4;

-- SELECT * FROM actors4 WHERE first_name LIKE '%e%';

SELECT * FROM actors4 WHERE number_oscars >= 5;