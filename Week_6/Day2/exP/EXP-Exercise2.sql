...
--12--
-- Write a query which will join the data in the customer table and the payment table. You want to get the first name and 
-- last name from the curstomer table, as well as the amount and the date of every payment made by a customer, 
...
-- WHERE film.film_id NOT IN (SELECT film_id FROM inventory WHERE id IS NULL);
--14--
...
--15--
--Bonus You want to be able to see how your sellers have been doing? Write a query to get the customer’s id, name
